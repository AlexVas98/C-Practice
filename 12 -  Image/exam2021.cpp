...
int main(int argc, char** argv) {
    ...
    unsigned long seed = 123123; // atoi(argv[1]);
...
void Test1(unsigned long seed) {
    ...
    graphics::Image im1; // To be implemented: default c-tor
    ...
    graphics::Image im2(dim, dim); // To be implemented: ser defined c-tor
    ...
    unsigned char* newpixel = im2(pixel % dim, pixel / dim); // To be implemented: getter()

    newpixel[0] = rgb[0];
    newpixel[1] = rgb[1];
    newpixel[2] = rgb[2];

    im1 = im2; // To be implemented: op=
